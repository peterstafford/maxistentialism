...
<footer class="content-info bg-black-400 relative overflow-hidden h-68 lg:h-20 xl:h-32">
	<!-- Mobile -->
	<img src="<?php echo $m_img; ?>" alt="Geometric Shapes With Smiling Faces" class="absolute inset-0 object-cover w-full lg:hidden">
	...
	<!-- Desktop -->
	<img src="<?php echo $d_img; ?>" alt="Geometric Shapes With Smiling Faces" class="hidden absolute inset-0 object-cover w-full hidden lg:block">
